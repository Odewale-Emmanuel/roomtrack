    ...
    <main className="p-4 md:py-5 grow-1">
      <div className="mx-auto flex flex-col gap-8 w-full lg:max-w-6xl">
        <header className="flex flex-col bordoer border-gray-200">
          <h2
            className={cn(
              "inline-block text-black/85 mb-2 md:mb-4 text-lg md:text-xl font-bold",
        ...
        <section className="flex flex-col gap-4 sm:gap-6 border border-gray-200 bg-white rounded-2xl p-4 sm:p-5">
          <header className="flex justify-between items-center">
            ...
            <button
              className="border border-blue-600 text-blue-600 hover:bg-gradient-to-r from-blue-500 to-blue-600 hover:text-white hover:border-transparent text-sm hover:font-bold px-2 py-1 sm:px-4 sm:py-2 rounded-sm sm:rounded-md"
            ...
            <dialog className="mx-auto translate-y-[-50%] fixed top-1/2 w-10/12 max-w-md p-6 bg-white rounded-xl z-50 backdrop:bg-black/20 backdrop:backdrop-blur-sm">
              <form
                method="dialog"
              ...
              >
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="bg-blue-600 text-white rounded-md px-4 py-2 w-full hover:bg-blue-600/80 font-semibold"
                  >
                    Add Room
                  </button>
                </div>
